...
class CsvExporter:
    ...
    def export_for_excel(self, settlement_result, transactions, all_transactions=None, ignored_transactions=None):
        ...
        with open(filepath, "w", newline="", encoding="utf-8") as csvfile:
            ...
            self._write_header_with_analysis(writer, settlement_result, transactions, all_transactions, ignored_transactions)
    ...
    def _write_header_with_analysis(self, writer, settlement_result, transactions, all_transactions, ignored_transactions):
    ...
    def _determine_expense_category(self, recipient):
        ...
        # Lebensmittel
        food_keywords = ['aldi', 'lidl', 'rewe', 'edeka', 'netto', 'kaufland', 'supermarkt', 'penny']
        ...
        restaurant_keywords = ['restaurant', 'gastro', 'wirtshaus', 'cafe', 'bar', 'bistro', 'pizza']
        if any(keyword in recipient_lower for keyword in restaurant_keywords):
            return "Gastronomie"
        
        # Utilities
        utility_keywords = ['stadtwerke', 'energie', 'strom', 'gas', 'wasser', 'eprimo', 'naturwerke']
